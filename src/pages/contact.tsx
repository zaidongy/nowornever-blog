  ...
  public render() {
    return (
      <Layout>
        ...
        <Wrapper>
          <Content>
            <p>Connect with me on LinkedIn or visit my Github!</p>
            <a href="https://www.linkedin.com/in/zaidongyang" target="_blank">
              <Button big>
            ...
            <a href="https://github.com/zaidongy/" target="_blank">
              <Button big>
            ...
            <a href="https://chrisyang.io" target="_blank">
              <Button big>
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="location-arrow" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
